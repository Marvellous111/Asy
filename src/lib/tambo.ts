...
export const tools: TamboTool[] = [
  ...
  },
  {
    name: "resizeFont",
    description:
      "Adjusts the font size of the page for accessibility, especially for visually impaired users. Call this when the user requests to make text bigger or smaller, providing a multiplier (e.g., 1.5 for 150%, 0.8 for 80%).",
    tool: resizeFont,
    toolSchema: z
      .function()
      .args(z.number().describe("Font size multiplier (e.g., 1.5 for 150%, 0.8 for 80%)"))
      .returns(
        z.object({
          newFontSize: z.number(),
          message: z.string(),
        })
      ),
  },
  {
    ...
    toolSchema: z
      .function()
      .args(z.string().describe("Color blindness type (protanopia, deuteranopia, tritanopia)"))
      .returns(
        z.object({
          filterId: z.string(),
          message: z.string(),
